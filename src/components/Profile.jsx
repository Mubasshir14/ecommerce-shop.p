                ...
                <div className="flex flex-col justify-center  p-6 shadow-md rounded-xl sm:px-12  border-black border-2">
                    ...
                    <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                        ...
                        <div className="flex justify-center pt-2 space-x-4 align-center">
                            <a rel="noopener noreferrer" href="#" aria-label="GitHub" className="p-2 rounded-md  hover:dark:text-violet-600">
                            ...
                            <a rel="noopener noreferrer" href="#" aria-label="Dribble" className="p-2 rounded-md  hover:dark:text-violet-600">
                            ...
                            <a rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-2 rounded-md  hover:dark:text-violet-600">
                                <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                            ...
                            <a rel="noopener noreferrer" href="#" aria-label="Email" className="p-2 rounded-md  hover:dark:text-violet-600">
                                <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                        ...
                        <div className='mt-3 '>
                            <button
                                ...
                                className="btn border-2 border-black mt-3">Log Out</button>
                        </div>
                    </div>
                </div>
            </div>
