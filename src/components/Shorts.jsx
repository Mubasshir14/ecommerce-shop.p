...
const Shorts = () => {
    ...
    const filterShorts = product.filter(s => s.category === 'shorts');
        ...
        <div className='max-w-screen-xl mx-auto'>
            ...
            <div className='flex justify-between items-center p-4'>
                ...
                <div className='flex-1 lg:mt-12 mb-6 p-2'>
                    ...
                    <h1 className='md:text-4xl text-2xl  uppercase font-extrabold text-center mb-4'>Shorts</h1>
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3'>
                        {filterShorts.map(product => (
